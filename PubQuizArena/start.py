...
PORT = int(os.environ.get("PUBQUIZ_PORT", "8002"))

# If port is already taken, try next ones
for port in [int(os.environ.get("PUBQUIZ_PORT", "8002")), 
             int(os.environ.get("PUBQUIZ_PORT", "8002")) + 1,
             int(os.environ.get("PUBQUIZ_PORT", "8002")) + 2]:
    PORT = port
    try:
        import socket
